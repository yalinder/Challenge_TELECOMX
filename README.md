...
<h3> Introducción </h3>
 ...
 Análisis exploratorio de datos sobre deserción de clientes en Telecom X. Este proyecto busca comprender los factores que impulsan la deserción y generar insights accionables para:Se realiza crea un análisis del proyecto "Churn de Clientes". La empresa enfrenta una alta tasa de cancelaciones y necesita comprender los factores que llevan a la pérdida de clientes.
